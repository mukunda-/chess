drop table pgns cascade;
drop table games cascade;
drop table boards cascade;
drop table endgames cascade;
drop table continuations cascade;
...
CREATE TABLE IF NOT EXISTS continuations (
    ...
    FOREIGN KEY (board_hash) REFERENCES boards (hash),
    PRIMARY KEY (game_id, board_hash, move_san),
    unique nulls not distinct (game_id, board_hash, move_san)
);
